...
export function QuoteIcon({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M9.5 5C6.5 6.4 4.6 9.2 4.6 12.6c0 3.5 2 5.9 4.7 5.9 2.2 0 3.8-1.6 3.8-3.7 0-2-1.4-3.5-3.3-3.5-.4 0-.8.1-1 .2.4-1.7 2-3.4 3.8-4.2L9.5 5Zm9.6 0c-3 1.4-4.9 4.2-4.9 7.6 0 3.5 2 5.9 4.7 5.9 2.2 0 3.8-1.6 3.8-3.7 0-2-1.4-3.5-3.3-3.5-.4 0-.8.1-1 .2.4-1.7 2-3.4 3.8-4.2L19.1 5Z" />
    </svg>
  );
}
