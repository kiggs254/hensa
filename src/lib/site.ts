export const site = {
  ...
  seoDescription:
    "Hensa Solutions is a Nairobi-based printing and promotional branding company providing large-format printing, corporate gifts, branded merchandise, event branding and promotional products to businesses, institutions and organizations across Kenya.",
