  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Tell us the product or service, quantity, colours, branding and any deadline, via WhatsApp (+254 721 597714), phone, email (info@hensa.co.ke) or the enquiry form on any product page. Our team replies with options, materials and a price. There is no online checkout; every job is quoted individually.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. Hensa Solutions produces election and campaign merchandise for every party and candidate on a strictly non-partisan basis. We print branded t-shirts, caps, lessos, reflectors, banners, flags and full regalia in your party colours, delivered to any county. See our campaign range in the catalog.",
      },
    ],
  },
];
