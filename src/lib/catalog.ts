...
const CATEGORY_META: Record<string, { blurb: string; image: string; order: number }> = {
  ...
  "trophies-awards": { order: 2.5, blurb: "Trophies, medals, plaques, shields, and crystal, glass, wood or resin awards, engraved and branded to order.", image: "/categories/corporate-gifts.jpg" },
